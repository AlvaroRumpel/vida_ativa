...
**Current state:** v2.0 em desenvolvimento — v1.0 live em `vida-ativa-94ba0.web.app`. 21 requirements v1 entregues. Phase 07 complete — visibilidade social (SOCIAL-01, SOCIAL-02, ADMN-09). Phase 08 complete — compartilhamento WhatsApp + telefone no perfil (SOCIAL-03, PROF-01). v2.0 foca em funcionalidades sociais, UX admin, e monitoramento de erros (10 requirements, 6 fases a partir da 07).
