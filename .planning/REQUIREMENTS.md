...
- [ ] **PIX-06**: Admin vê status de pagamento na listagem de reservas e no detalhe (bottomsheet); pode confirmar manualmente em caso de falha no webhook
- [ ] **PIX-07**: Reservas com pagamento expirado são automaticamente marcadas como `expired` por Cloud Function após 45 min; slot liberado para nova reserva
...
| PIX-06 | Phase 18 | Pending |
| PIX-07 | Phase 18 | Pending |
